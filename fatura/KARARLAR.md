...
13. **Müşteri kartları (musteri-kesif.js):** Elle açılan kartlarda e-posta boş, her faturada yeni kart açılmış. Program e-postayla arar; bulamazsa `name, email, contact_type=person, account_type=customer, tax_number=11111111111, city + district (`iller.js`, bkz. madde 15), address, phone, is_abroad=false` ile açar. Alan adları gerçek kayıttan doğrulandı.
